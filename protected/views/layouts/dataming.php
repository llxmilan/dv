	...
	<div class='row' style="margin-top:20px">
		...
		<div id='firstmenu' class="span8">
                	<?php $this->widget('bootstrap.widgets.TbMenu', array(
                        	...
                        	'items'=>array(
                                	array('label'=>'首页', 'icon'=>'home', 'url'=>array('#')),
                    	            	array('label'=>'个性化推荐', 'icon'=>'th','url'=>array('#')),
                                	array('label'=>'广告效果分析', 'icon'=>'leaf','url'=>array('#')),
					array('label'=>'风险预测和欺诈检测', 'icon'=>'camera','url'=>array('#')),
